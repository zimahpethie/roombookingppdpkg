	...
	<div class="input-group">
	 ...
	 <label style="color:red">*</label>Emel
  	...
  	<div style="clear: both;"><div class="input-group">
  	  <p class="alignleft"><button type="reset" class="btn" name="registeruser">Reset</button></p> <p class="alignright"><button type="submit" class="btn" name="registeruser">Daftar</button></p>
  	</div></div><br><br><br>
  	<p>
  		<a href="index.php" style="float: left">Kembali</a> <a href="userlogin.php" style="float: right">Log Masuk</a><br>
  	</p>
  </form>
