...
<div class="navbar">
  ...
  <a href="adminprofilelist.php">Senarai Pengguna</a>
     <a href="adminroom.php" class="active">Senarai Bilik</a>
...
<table class="listtable" style="border:0px">
	<thead>
	 <tr>
			...
			<p>Pendingin hawa, kerusi, meja, sistem siar raya, projektor dan sebagainya</p>
 </th></tr>
		...
		<tr>
			...
			<p>Terdapat kemudahan seperti:</p>
			<p>Pendingin hawa, kerusi, meja, projektor dan sebagainya</p>
 </th></tr>
